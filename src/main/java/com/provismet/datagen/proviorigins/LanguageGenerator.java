...
public class LanguageGenerator extends LilyLanguageProvider {
    ...
    public void generateTranslations (RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder) {
        ...
        addPower(translationBuilder, PowerNames.JellySculk.CREATE_SENSOR, "Spreading Your Senses", "You can spend experience to grow a sculk sensor on top of a sculk block.", "[USE] with an empty hand while sneaking to activate.");
        ...
        addPower(translationBuilder, PowerNames.JellySculk.SPREAD_SCULK, "Spreading Your Domain", "You can spend experience points to spread sculk to any sculk replaceable block.", "[USE] with an empty hand while sneaking to activate.");

...
public class DoubleJumpAction extends EntityActionType {
    ...
    public void accept (EntityActionContext context) {
        Vec3d currentVelocity = context.entity().getVelocity();
        context.entity().setVelocity(currentVelocity.x, this.velocity, currentVelocity.z);
        context.entity().velocityModified = true;

        if (this.resetFall) context.entity().fallDistance = 0;
    }

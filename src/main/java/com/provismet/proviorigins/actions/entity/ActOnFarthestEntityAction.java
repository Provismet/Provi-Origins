...
public class ActOnFarthestEntityAction extends EntityActionType {
    ...
    protected void execute (Entity entity) {
        ...
        for (Entity other : others) {
            if (this.condition.test(entity, other) && (farthest == null || entity.distanceTo(other) > entity.distanceTo(farthest))) farthest = other;
        }

        if (farthest != null) this.action.execute(entity, farthest);
    }

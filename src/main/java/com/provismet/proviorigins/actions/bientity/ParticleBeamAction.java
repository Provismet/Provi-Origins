...
public class ParticleBeamAction extends BiEntityActionType {
    ...
    public void execute (Entity actor, Entity target) {
        ...
        Vec3d startPos = actor.getPos().add(0.0, this.actorY, 0.0);
        Vec3d currentPos = actor.getPos().add(0.0, this.actorY, 0.0);
        Vec3d destPos = target.getPos().add(0.0, this.targetY, 0.0);
